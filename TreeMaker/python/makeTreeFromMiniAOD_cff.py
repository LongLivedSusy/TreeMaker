...
def makeTreeFromMiniAOD(self,process):
	...
	if self.readFiles_sidecar:
			...
			process.DisappearingTracks = disappearingTracks.clone(
				...
				minTrackPt = cms.double(2),
				maxTrackEta = cms.double(5.0),
				maxDxy = cms.double(99999),
				maxDz = cms.double(99999),               
					)
			self.VectorTLorentzVector.extend(['DisappearingTracks:tracks(tracks)'])
			self.VectorDouble.extend(['DisappearingTracks:tracks@dxyVtx(tracks_dxyVtx)'])
			self.VectorDouble.extend(['DisappearingTracks:tracks@dzVtx(tracks_dzVtx)'])
			self.VectorInt.extend(['DisappearingTracks:tracks@pixelLayersWithMeasurement(tracks_pixelLayersWithMeasurement)'])
			self.VectorInt.extend(['DisappearingTracks:tracks@trackerLayersWithMeasurement(tracks_trackerLayersWithMeasurement)'])
			self.VectorInt.extend(['DisappearingTracks:tracks@nMissingOuterHits(tracks_nMissingOuterHits)'])
			self.VectorInt.extend(['DisappearingTracks:tracks@nMissingInnerHits(tracks_nMissingInnerHits)'])
			self.VectorInt.extend(['DisappearingTracks:tracks@nMissingMiddleHits(tracks_nMissingMiddleHits)']) 
			self.VectorInt.extend(['DisappearingTracks:tracks@nValidPixelHits(tracks_nValidPixelHits)']) 
			self.VectorInt.extend(['DisappearingTracks:tracks@nValidTrackerHits(tracks_nValidTrackerHits)']) 
			self.VectorDouble.extend(['DisappearingTracks:tracks@ptError(tracks_ptError)'])          
			self.VectorDouble.extend(['DisappearingTracks:tracks@chi2perNdof(tracks_chi2perNdof)'])          
			self.VectorDouble.extend(['DisappearingTracks:tracks@trkRelIso(tracks_trkRelIso)'])   
			self.VectorDouble.extend(['DisappearingTracks:tracks@trkMiniRelIso(tracks_trkMiniRelIso)'])          
			self.VectorDouble.extend(['DisappearingTracks:tracks@trackJetIso(tracks_trackJetIso)'])
			self.VectorDouble.extend(['DisappearingTracks:tracks@trackLeptonIso(tracks_trackLeptonIso)'])                    
			self.VectorDouble.extend(['DisappearingTracks:tracks@matchedCaloEnergyJets(tracks_matchedCaloEnergyJets)'])
			self.VectorDouble.extend(['DisappearingTracks:tracks@matchedCaloEnergy(tracks_matchedCaloEnergy)'])
			self.VectorDouble.extend(['DisappearingTracks:tracks@chargedPtSum(tracks_chargedPtSum)'])
			self.VectorDouble.extend(['DisappearingTracks:tracks@neutralPtSum(tracks_neutralPtSum)'])
			self.VectorDouble.extend(['DisappearingTracks:tracks@neutralWithoutGammaPtSum(tracks_neutralWithoutGammaPtSum)'])
			if not self.fastsim: 
				self.VectorDouble.extend(['DisappearingTracks:tracks@deDxHarmonic2(tracks_deDxHarmonic2)']) 
			self.VectorBool.extend(['DisappearingTracks:tracks@passExo16044DeadNoisyECALVeto(tracks_passExo16044DeadNoisyECALVeto)']) 
			self.VectorBool.extend(['DisappearingTracks:tracks@passExo16044GapsVeto(tracks_passExo16044GapsVeto)'])
			self.VectorBool.extend(['DisappearingTracks:tracks@passPFCandVeto(tracks_passPFCandVeto)'])  
			self.VectorBool.extend(['DisappearingTracks:tracks@passExo16044Tag(tracks_passExo16044Tag)']) 
			self.VectorBool.extend(['DisappearingTracks:tracks@passExo16044JetIso(tracks_passExo16044JetIso)']) 
			self.VectorBool.extend(['DisappearingTracks:tracks@passExo16044LepIso(tracks_passExo16044LepIso)'])        
			self.VectorBool.extend(['DisappearingTracks:tracks@trackQualityUndef(tracks_trackQualityUndef)'])        
			self.VectorBool.extend(['DisappearingTracks:tracks@trackQualityLoose(tracks_trackQualityLoose)'])        
			self.VectorBool.extend(['DisappearingTracks:tracks@trackQualityTight(tracks_trackQualityTight)'])        
			self.VectorBool.extend(['DisappearingTracks:tracks@trackQualityHighPurity(tracks_trackQualityHighPurity)'])        
			self.VectorBool.extend(['DisappearingTracks:tracks@trackQualityConfirmed(tracks_trackQualityConfirmed)'])        
			self.VectorBool.extend(['DisappearingTracks:tracks@trackQualityGoodIterative(tracks_trackQualityGoodIterative)'])        
			self.VectorBool.extend(['DisappearingTracks:tracks@trackQualityLooseSetWithPV(tracks_trackQualityLooseSetWithPV)'])        
			self.VectorBool.extend(['DisappearingTracks:tracks@trackQualityHighPuritySetWithPV(tracks_trackQualityHighPuritySetWithPV)'])        
			self.VectorBool.extend(['DisappearingTracks:tracks@trackQualityDiscarded(tracks_trackQualityDiscarded)'])        
			self.VectorBool.extend(['DisappearingTracks:tracks@trackQualitySize(tracks_trackQualitySize)'])        
			self.VectorInt.extend(['DisappearingTracks:tracks@charge(tracks_charge)'])
	...
	process.LeptonsNew = leptonproducer.clone(
		...
		minElecPt        = cms.double(2),
		maxElecEta       = cms.double(2.5),
		minMuPt          = cms.double(2),
