...
def makeTreeFromMiniAOD(self,process):
	...
	if self.readFiles_sidecar:
			...
			if not self.fastsim: 
				self.VectorDouble.extend(['DisappearingTracks:chiCands@deDxHarmonic2(chiCands_deDxHarmonic2)']) 
			self.VectorBool.extend(['DisappearingTracks:chiCands@passExo16044DeadNoisyECALVeto(chiCands_passExo16044DeadNoisyECALVeto)']) 
			self.VectorBool.extend(['DisappearingTracks:chiCands@passExo16044GapsVeto(chiCands_passExo16044GapsVeto)'])
			...
			self.VectorDouble.extend(['DisappearingTracks:chiCands@charge(chiCands_charge)'])
